<main class="p-6">
    <div class="container mx-auto">
        ...
        <button class="bg-blue-600 hover:bg-blue-500 text-white font-semibold py-2 px-4 rounded-lg shadow-md flex items-center space-x-2" onclick="toggleModal('addProductModal')">
            <!-- Icône SVG -->
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <table class="table-auto w-full border-collapse border">
                ...
                <tbody class="text-gray-700 text-sm font-medium">
                    ...
                    <tr class="hover:bg-gray-100 transition-colors duration-200">
                        ...
                        <img src="/E-Stock/public/<?= htmlspecialchars($product->getPathImage()) ?>" alt="Image du produit" class="w-32 h-32 object-cover" />
                        </td>
                        ...
                        <td class="py-3 px-6 text-center border flex justify-center space-x-4">
                            ...
                            <!-- Supprimer bouton -->
                            <form method="POST" action="/Product/delete" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ce produit ?')">
            ...
            <!-- Edit Modal -->
<div id="editProductModal" class="modal hidden fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center">
    <div class="bg-white rounded-lg shadow-md p-6 w-96">
        ...
        <form method="POST" action="/Product/edit" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="file" id="editProductImage" name="pathImage" class="w-full border rounded-lg px-3 py-2" accept="image/*">
            </div>
            <div class="mb-4">
                <label for="editProductDesignation" class="block text-sm font-semibold mb-2">Désignation</label>
                <input type="text" id="editProductDesignation" name="designation" class="w-full border rounded-lg px-3 py-2" required>
            </div>
            <div class="mb-4">
                <label for="editProductPrix" class="block text-sm font-semibold mb-2">Prix</label>
                <input type="number" id="editProductPrix" name="prix" class="w-full border rounded-lg px-3 py-2" required>
            </div>
            <div class="mb-4">
                <label for="editProductQtt" class="block text-sm font-semibold mb-2">Quantité</label>
                <input type="number" id="editProductQtt" name="qtt" class="w-full border rounded-lg px-3 py-2" required>
            </div>
            <div class="mb-4">
                <label for="editProductCategory" class="block text-sm font-semibold mb-2">Catégorie</label>
                <select id="editProductCategory" name="idCategorie" class="w-full border rounded-lg px-3 py-2" required>
            ...
            <div class="flex justify-end space-x-2">
                <button type="button" class="bg-gray-300 hover:bg-gray-400 text-gray-700 py-2 px-4 rounded-lg" onclick="toggleModal('editProductModal')">Annuler</button>
                <button type="submit" class="bg-blue-600 hover:bg-blue-500 text-white py-2 px-4 rounded-lg">Modifier</button>
            </div>
        </form>
    </div>
</div>
    ...
    <!-- Ajouter Modal -->
    <div id="addProductModal" class="modal hidden fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center">
        <div class="bg-white rounded-lg shadow-md p-6 w-96">
    ...
    <input type="file" name="pathImage" class="w-full border rounded-lg px-3 py-2" accept="image/*" required>
</div>

                <div class="mb-4">
                    <label for="designation" class="block text-sm font-semibold mb-2">Désignation</label>
                    <input type="text" name="designation" placeholder="Nom du produit" class="w-full border rounded-lg px-3 py-2" required>
                </div>
                <div class="mb-4">
                    <label for="prix" class="block text-sm font-semibold mb-2">Prix</label>
                    <input type="number" name="prix" placeholder="Prix en MAD" class="w-full border rounded-lg px-3 py-2" required>
                </div>
                <div class="mb-4">
                    <label for="qtt" class="block text-sm font-semibold mb-2">Quantité</label>
                    <input type="number" name="qtt" placeholder="Quantité" class="w-full border rounded-lg px-3 py-2" required>
                </div>
                <div class="mb-4">
                ...
                <div class="flex justify-end space-x-2">
                    <button type="button" class="bg-gray-300 hover:bg-gray-400 text-gray-700 py-2 px-4 rounded-lg" onclick="toggleModal('addProductModal')">Annuler</button>
                    <button type="submit" class="bg-blue-600 hover:bg-blue-500 text-white py-2 px-4 rounded-lg">Ajouter</button>
                </div>
            </form>
        </div>
    </div>
