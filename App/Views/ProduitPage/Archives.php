<main class="p-6">
    <div class="container mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <table class="table-auto w-full border-collapse border" id="ProduitArchiveTable">
                <thead>
                    ...
                    <?php foreach ($deletedProducts as $product): ?>
                        <tr class="hover:bg-gray-100 transition-colors duration-200">
                            ...
                            <td class="py-3 px-6 border">
                                <img src="/E-Stock/public/<?= htmlspecialchars($product['pathImage']) ?>"
                                    alt="Image produit" class="w-16 h-16 object-cover">
                            </td>
...
<script>
    ...
    function filterTable() {
        ...
        const table = document.getElementById('ProduitArchiveTable');
